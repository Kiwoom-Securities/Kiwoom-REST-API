...
async def subscribe_domestic_international_gold_converted_price_pubsub(
    items: list[str],
    ...
    """
    국제금환산가격[0I] 실시간 데이터를 Pub/Sub로 분배합니다.
...
async def main() -> None:
    ...
    await subscribe_domestic_international_gold_converted_price_pubsub(
        items=['MGD'],
        types=['0I'],
        max_messages=None,
    )
