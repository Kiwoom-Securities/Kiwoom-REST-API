...
async def subscribe_domestic_international_gold_converted_price_async(
    items: list[str],
    ...
    Example:
        >>> result = await subscribe_domestic_international_gold_converted_price_async(
        ...     items=['MGD'],
        ...     types=['0I'],
        ... )
